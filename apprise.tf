module "apprise" {
  source = "git@github.com:steled/terraformmodules.git//apprise?ref=v0.10"
  # source = "../terraformmodules/apprise/"

  # renovate: datasource=docker depName=apprise packageName=caronc/apprise
  apprise_version             = "1.1.7" # check version here: https://registry.hub.docker.com/r/caronc/apprise/tags
