module "nextcloud" {
  source = "git@github.com:steled/terraformmodules.git//nextcloud?ref=v0.14"
  ...
  nextcloud_version         = "6.6.3" # get version from here: https://github.com/nextcloud/helm/blob/main/charts/nextcloud/Chart.yaml#L3
