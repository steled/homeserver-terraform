module "victoriametrics" {
  source = "git@github.com:steled/terraformmodules.git//victoriametrics?ref=v0.10"
  ...
  victoriametrics_version   = "0.33.5" # check version here: https://github.com/VictoriaMetrics/helm-charts/blob/master/charts/victoria-metrics-k8s-stack/Chart.yaml#L5
