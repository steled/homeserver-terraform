module "victoriametrics" {
  source = "git@github.com:steled/terraformmodules.git//victoriametrics?ref=v0.11"
  # source = "../terraformmodules/victoriametrics/"

  # renovate: datasource=docker depName=haproxy packageName=haproxy
  haproxy_version = "3.1.2-alpine" # check version here: https://hub.docker.com/_/haproxy/tags?name=alpine
  # renovate: datasource=github-tags depName=victoriametrics packageName=VictoriaMetrics/helm-charts
  victoriametrics_version   = "0.34.0" # check version here: https://github.com/VictoriaMetrics/helm-charts/blob/master/charts/victoria-metrics-k8s-stack/Chart.yaml#L5
