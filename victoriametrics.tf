module "victoriametrics" {
  ...
  victoriametrics_version   = "0.35.2" # check version here: https://github.com/VictoriaMetrics/helm-charts/blob/master/charts/victoria-metrics-k8s-stack/Chart.yaml#L5
